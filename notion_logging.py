...
def get_or_create_strategy(strategy_name, strategy_version, strategy_description):
    ...
    data = {
        ...
        "filter": {
            "and": [
                {"property": "Name", "title": {"equals": strategy_name}},
                {"property": "Version", "number": {"equals": strategy_version}},
            ]
        },
    }
    ...
    data = {
        ...
        "properties": {
            ...
            "Version": {"number": strategy_version},
            "Description": {
                "rich_text": [
                    {"type": "text", "text": {"content": strategy_description}}
                ]
            },
        },
    }
...
def create_grocery_shopping_log(store_name, start_time, strategy_id):
    ...
    data = {
        ...
        "properties": {
            ...
            "Strategy": {"relation": [{"id": strategy_id}]},
        },
    }
    response = requests.post(url, data=json.dumps(data), headers=headers)
    response.raise_for_status()
